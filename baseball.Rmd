...
```{r}
# data cleaning
mlb2022 <- merge(team.pitching.2022, team.batting.2022,by="Tm")
mlb2021 <- merge(team.pitching.2021, team.batting.2021,by="Tm")
mlb2020 <- merge(team.pitching.2020, team.batting.2020,by="Tm")
mlb2019 <- merge(team.pitching.2019, team.batting.2019,by="Tm")
mlb2018 <- merge(team.pitching.2018, team.batting.2018,by="Tm")

player2022 <- merge(player.pitching.2022, player.pitching.2022,by="Tm")
