...
plot(W.L..next_year ~ OPS., data=train.df,
     xlab="Adjusted On Base Percentage Plus Slugging", ylab="Winning Percentage")
plot(W.L..next_year ~ ERA., data=train.df,
...
```{r}
# Correlation matrix
cor(train.df[, c("W.L..next_year", "Age.bat", "Age.pitch", "BA", "HR.bat", "OPS", "ERA.", "SO.W", "HR9", "WHIP")])
cor(train.df[, c("W.L..next_year", "Age.bat", "Age.pitch", "BA", "HR.bat", "OPS", "ERA.", "SO.W", "HR9", "WHIP")])^2
```
