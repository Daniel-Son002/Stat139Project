...
plot(W.L..y ~ PA, data=player_with_wins_combined,
...
plot(W.L..y ~ H.x, data=player_with_wins_combined,
     xlab="Average Hits", ylab="Winning Percentage")
plot(W.L..y ~ H.y, data=player_with_wins_combined,
     xlab="Average Hits Allowed", ylab="Winning Percentage")
plot(W.L..y ~ ERA., data=player_with_wins_combined,
     xlab="Earned Run Average", ylab="Winning Percentage")
...
baseline <- lm(W.L..y ~ Age.x + PA + BA + HR.x + 
                 H.x + H.y + ERA. + SO.W + WHIP, data = player_with_wins_combined)
summary(baseline)
```
