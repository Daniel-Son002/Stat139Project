...
```{r, cache=TRUE}
set.seed(139)
lmer.varmodel <- lmer(W.L..next_year ~ OBP + Fld. + SLG + OPS + WHIP | Tm , data = train.df)
RMSE(train.df$W.L..next_year, predict(lmer.varmodel))
RMSE(test.df$W.L..next_year, predict(lmer.varmodel, newdata=test.df))
```
...
```{r, cache=TRUE}
set.seed(139)
lmer.varmodel <- lmer(W.L..next_year ~ Fld. + BA:OBP + OBP:Fld. + OBP:SLG + OBP | Tm , data = train.df)
RMSE(train.df$W.L..next_year, predict(lmer.varmodel))
RMSE(test.df$W.L..next_year, predict(lmer.varmodel, newdata=test.df))
```
...
```{r, cache=TRUE}
set.seed(139)
lmer.varmodel <- lmer(W.L..next_year ~ OBP + SLG + WHIP + Fld. + SHO | Tm , data = train.df)
RMSE(train.df$W.L..next_year, predict(lmer.varmodel))
RMSE(test.df$W.L..next_year, predict(lmer.varmodel, newdata=test.df))
```
...
```{r, cache=TRUE}
set.seed(139)
lmer.varmodel <- lmer(W.L..next_year ~ OBP:Fld. + SLG:Fld. + OBP + SH:SHO + IBB.pitch:BK | Tm , data = train.df)
RMSE(train.df$W.L..next_year, predict(lmer.varmodel))
RMSE(test.df$W.L..next_year, predict(lmer.varmodel, newdata=test.df))
```
...
```{r, cache=TRUE}
set.seed(139)
lmer.varmodel <- lmer(W.L..next_year ~ tot_fa_war3 + AB + PA + num_fas + X3B | Tm, data = train.df)
RMSE(train.df$W.L..next_year, predict(lmer.varmodel))
RMSE(test.df$W.L..next_year, predict(lmer.varmodel, newdata=test.df))
```
...
**Prunded Decision tree with 3 Predictors**
```{r, cache=TRUE}
set.seed(139)
lmer.varmodel <- lmer(W.L..next_year ~ W.L..same_year + WHIP + Age.pitch | Tm , data = train.df)
RMSE(train.df$W.L..next_year, predict(lmer.varmodel))
